...
export default function Tutorials() {
  ...
  return (
    <section id="tutorials" className="relative overflow-hidden bg-gradient-to-b from-black/40 via-black/20 to-black backdrop-blur-[2px] py-16 px-4 sm:px-6 lg:px-8">
